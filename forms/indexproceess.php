...
if(isset($_POST['send'])) {
    ...
    if(strlen($password)  != 8 ){
        $error .= "please enter password with 8 char<br />";
    }

    $pattern ="/[0-9]{10,14}/";
    if(!preg_match($pattern, $phone)){
        $error .= "Please enter phone number with numbers only<br />";
    }
...
<body>
    ...
    <legend>Account Information</legend>
        ...
        <input type="password" name="password" value="<?php  ?>" class="textbox"/>
        <br />
