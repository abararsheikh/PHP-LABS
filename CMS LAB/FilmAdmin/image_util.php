<?php
function process_image($dir, $file_get) {
    // Set up the variables
    $dir = $dir . DIRECTORY_SEPARATOR;

    $i = strrpos($file_get, '.');

    $image_name = substr($file_get, 0, $i);
    $ext = substr($file_get, $i);

    // Set up the read path
    $image_path = $dir . DIRECTORY_SEPARATOR . $file_get;
//echo $image_path;
...
//echo $image_path_400;
    ...
    resize_image($image_path, $image_path_400, 400, 450);
